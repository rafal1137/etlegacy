...
:GENERATECMAKE
	...
	IF !etpub!==1 (
		...
		-DFEATURE_HW_BAN="1" ^
		-DFEATURE_USE_BODY_QUE="1" ^
		-DFEATURE_AUTO_GUID="1" ^
		-DFEATURE_VISIBLE_TRIGGERS="0" ^
		-DFEATURE_GEN_FLAME_SHADER="0" ^
		-DFEATURE_BLOOD_PARTICLE_TRAI="0" ^
		-DFEATURE_SYSTEM_CHECK="0" ^
		-D__SSYSTEM__="0" ^
		-DFEATURE_FAKELAG="0" ^
		-DFEATURE_DEBUG_NQKEY="0" ^
		-D__SSYSTEM_WIP__="0" ^
		-D__SKIN_SYSTEM__="0" ^
		-DFEATURE_AUTHORIZE_SUPPORT="0" ^
		-DFEATURE_DBGANIMEVENTS="0" ^
		-DQAGAME="1" ^
		-DFEATURE_PROFILER="1" ^
		-DFEATURE_NQ_USE_PROFILER="0" ^
		-DFEATURE_PRINTING_TO_CONSOLE_ALLOWED="1" ^
		-DFEATURE_BONE_HITTESTS="0" ^
		-DFEATURE_CHEATS="0" ^
		-DPUNKBUSTER="0" ^
		-DFEATURE_NQ_TEST="0" ^
		-D__CLIENTCMD__="0" ^
		-DFEATURE_RELAXED_FREE_ENTS="1" ^
		-DFEATURE_JAQU_WIP="0" ^
		-DFEATURE_LOCALIZATION_SUPPORT="0" ^
		-DFEATURE_NEWWAY="0" ^
		-DFEATURE_DBMS="1" ^
		-DFEATURE_RATING="0" ^
		-DFEATURE_PRESTIGE="0" ^
		-DFEATURE_NOQUARTER="1"
	)
